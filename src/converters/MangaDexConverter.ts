...
class MangaDexConverter extends Converter {
	...
	constructor(public tachiyomiSourceId: Long, public lang: string) {
		super();
	}
...
const MangaDexZH_HANSConverter = new MangaDexConverter(
	new Long(1378680342, 1198820576, false), // 5148895169070562838
	'zh-Hans'
);
const MangaDexZH_HANTConverter = new MangaDexConverter(
	new Long(1034623257, 347771339, false), // 1493666528525752601
	'zh-Hant'
);
...
const MangaDexPT_BRConverter = new MangaDexConverter(
	new Long(-1489537484, 618200170, false), // 2655149515337070132
	'pt-BR'
);
...
const MangaDexES_419Converter = new MangaDexConverter(
	new Long(-1406949678, 1149897775, false), // 4938773340256184018
	'es-419'
);
